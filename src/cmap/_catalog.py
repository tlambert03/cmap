...
CATALOG: CatalogDict = {
    ...
    "bilbao": {"data": "cmap.data._crameri.bilbao:bilbao", "category": "sequential"},
    "imola": {"data": "cmap.data._crameri.imola:imola", "category": "sequential"},
    "vik": {"data": "cmap.data._crameri.vik:vik", "category": "diverging"},
    "cork": {"data": "cmap.data._crameri.cork:cork", "category": "diverging"},
    "batlow": {"data": "cmap.data._crameri.batlow:batlow", "category": "sequential"},
    "turku": {"data": "cmap.data._crameri.turku:turku", "category": "sequential"},
    "vikO": {"data": "cmap.data._crameri.vikO:vikO", "category": "cyclic"},
    "broc": {"data": "cmap.data._crameri.broc:broc", "category": "diverging"},
    "batlowK": {"data": "cmap.data._crameri.batlowK:batlowK", "category": "sequential"},
    "bam": {"data": "cmap.data._crameri.bam:bam", "category": "diverging"},
    "tokyo": {"data": "cmap.data._crameri.tokyo:tokyo", "category": "sequential"},
    "roma": {"data": "cmap.data._crameri.roma:roma", "category": "diverging"},
    "batlowW": {"data": "cmap.data._crameri.batlowW:batlowW", "category": "sequential"},
    "nuuk": {"data": "cmap.data._crameri.nuuk:nuuk", "category": "sequential"},
    "lisbon": {"data": "cmap.data._crameri.lisbon:lisbon", "category": "diverging"},
    "oleron": {"data": "cmap.data._crameri.oleron:oleron", "category": "miscellaneous"},
    "vanimo": {"data": "cmap.data._crameri.vanimo:vanimo", "category": "diverging"},
    "lajolla": {"data": "cmap.data._crameri.lajolla:lajolla", "category": "sequential"},
    "buda": {"data": "cmap.data._crameri.buda:buda", "category": "sequential"},
    "corkO": {"data": "cmap.data._crameri.corkO:corkO", "category": "cyclic"},
    "devon": {"data": "cmap.data._crameri.devon:devon", "category": "sequential"},
    "davos": {"data": "cmap.data._crameri.davos:davos", "category": "sequential"},
    "bamako": {"data": "cmap.data._crameri.bamako:bamako", "category": "sequential"},
    "fes": {"data": "cmap.data._crameri.fes:fes", "category": "miscellaneous"},
    "oslo": {"data": "cmap.data._crameri.oslo:oslo", "category": "sequential"},
    "lapaz": {"data": "cmap.data._crameri.lapaz:lapaz", "category": "sequential"},
    "brocO": {"data": "cmap.data._crameri.brocO:brocO", "category": "cyclic"},
    "hawaii": {"data": "cmap.data._crameri.hawaii:hawaii", "category": "sequential"},
    "tofino": {"data": "cmap.data._crameri.tofino:tofino", "category": "diverging"},
    "berlin": {"data": "cmap.data._crameri.berlin:berlin", "category": "diverging"},
    "romaO": {"data": "cmap.data._crameri.romaO:romaO", "category": "cyclic"},
    "bukavu": {"data": "cmap.data._crameri.bukavu:bukavu", "category": "miscellaneous"},
    "grayC": {"data": "cmap.data._crameri.grayC:grayC", "category": "sequential"},
